...
# 이상치 값 확인해보기
boxplot.stats(pg_nax[pg_nax$species=='Gentoo',3])$out
boxplot.stats(pg_nax[pg_nax$species=='Adelie',4])$out
boxplot.stats(pg_nax[pg_nax$species=='Adelie',5])$out
boxplot.stats(pg_nax[pg_nax$species=='Chinstrap',6])$out
