...
| Col1                     | Col2                                      | Col3 |
|------------------------|------------------------|------------------------|
| runs_per_game            | 경기당 득점 수                            |      |
| ERA (earned run average) | (투수의) 방어율, 평균자책점               |      |
| intentional_walks        | 의도적인 볼넷                             |      |
| complete_game            | 완투 경기(한 투수가 1회부터 9회까지 혼자) |      |
| run_average_9            | ?                                         |      |
| shutouts                 | 완승(0점)                                 |      |
|                          |                                           |      |
...
```{r}
p <- ggplot(df_01, mapping = aes(average_age, team)) + geom_point()
p
```
